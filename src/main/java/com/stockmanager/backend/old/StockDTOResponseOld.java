...
public class StockDTOResponseOld {
    ...
    public StockDTOResponseOld() {
    }

    public StockDTOResponseOld(String ticker, String companyName, String sector, Double noOfShares, Double purchasePrice, Double currentPrice, BigDecimal currentReturn, BigDecimal currentReturnTotal, BigDecimal currentTotal, LocalDate buyDate) {
        this.ticker = ticker;
